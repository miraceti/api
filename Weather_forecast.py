...
def get_weather():
    ...
    city_info_label.config(text=city_name + "( LAT: " + city_lat + ", LON: " + city_lon + ")",font=large_font, bg=output_color)
...
output_frame = tkinter.LabelFrame(sky_frame, bg=output_color, width=425, height=225)
input_frame = tkinter.LabelFrame(grass_frame, bg=input_color, width=425)
